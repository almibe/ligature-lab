...
@genType
type value =
  String(string) | Int(bigint) | Identifier(identifier) | Bytes(Js.TypedArray2.Uint8Array.t)

@genType
type statement = (identifier, identifier, value)

module StatementComparator = Belt.Id.MakeComparableU({
  type t = statement
...
let networkFromArray = array => Belt.Set.fromArray(array, ~id=module(StatementComparator))
